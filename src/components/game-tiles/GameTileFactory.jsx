...
const GameTileFactory = ({ game, index, colorCoding = true, isDragDisabled = true, provided, snapshot, showTeamForm = true, isPinned = false, onTogglePin, isInDetailMode = false, onToggleDetailMode }) => {
