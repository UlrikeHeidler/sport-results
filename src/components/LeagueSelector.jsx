...
const LeagueSelector = ({ selectedLeagues, onLeagueToggle, availableLeagues }) => {
  const leagueInfo = {
    ...
    fbs: { name: 'FBS', fullName: 'College Football FBS Division', emoji: '🏈' },
    ...
    nba: { name: 'NBA', fullName: 'National Basketball Association', emoji: '🏀' },
    mls: { name: 'MLS', fullName: 'Major League Soccer', emoji: '⚽' },
    ncaaw: { name: 'NCAAW', fullName: 'Womens College Basketball', emoji: '🏀' },
